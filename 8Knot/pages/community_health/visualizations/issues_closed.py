            ...
            [
                ...
                dbc.Popover(
                    [
                        ...
                        dbc.PopoverBody(
                            """
                            Displays how many issues are closed during a given period.
                            """
                        ),
                    ],
...
# callback for issues closed graph
@callback(
...
def issues_over_time_graph(repolist, interval):
    ...
    logging.warning("ISSUES CLOSED - START")

    # test if there is data
    if df.empty:
        logging.warning("ISSUES CLOSED - NO DATA AVAILABLE")
        return nodata_graph
    ...
    logging.warning(f"ISSUES_CLOSED_VIZ - END - {time.perf_counter() - start}")
